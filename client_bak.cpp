...
#define IP "127.0.0.1"
#define PORT 4433
#define CERT_PATH "./misc/sslclientcert.pem"
#define KEY_PATH "./misc/sslclientkey.pem"
#define CAFILE "./misc/demoCA/cacert.pem"
...
int sslctx_init() {
  ...
  if (SSL_CTX_use_certificate_file(g_sslctx, CERT_PATH, SSL_FILETYPE_PEM) <=
      0) {
